  ...
  public static String[] usersInputs(int promptNumber, String structured){
    ...
    if (structured.equals("yes")){
      if (promptNumber == 1){
          ...
          inputs = new String[] {"adjective", "noun", "plural noun", "person in room(female)", "adjective", "article of clothing", "noun", "a city", "plural noun", "adjective", "part of the body",  "letter of the alphabet", "celebrity", "plural noun", "adjective", "a place", "part of the body", "adjective", "adjective", "verb", "plural noun", "number"};
        }
